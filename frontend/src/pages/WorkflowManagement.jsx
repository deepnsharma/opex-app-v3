...
// Workflow stages as per requirement (Steps 1-7)
const WORKFLOW_STAGES = [
  ...
  { step: 4, name: "MOC required?", role: "IL", responsibility: "Initiative Lead" },
  { step: 5, name: "MOC", role: "IL", responsibility: "Initiative Lead" },
  { step: 6, name: "CAPEX required?", role: "IL", responsibility: "Initiative Lead" },
  { step: 7, name: "CAPEX Process", role: "STLD", responsibility: "Site TSD Lead" }
];
...
const WorkflowManagement = () => {
  ...
  const handleApproval = async (initiative, action) => {
    try {
      ...
      // Add MOC specific data for step 4 and 5
      ...
      // Add CAPEX specific data for step 6 and 7
      ...
      <DialogContent className="max-w-2xl">
        ...
        <div className="space-y-6">
          ...
          {nextStep === 4 && (
            <div className="space-y-4">
              <div>
                <Label className="font-medium">Is MOC (Management of Change) required? *</Label>
          ...
          <div className="flex space-x-2 pt-4 border-t">
            ...
            <Button
              ...
              disabled={
                ...
                (nextStep === 4 && !mocRequired && mocRequired !== false) ||
                (nextStep === 4 && mocRequired && !mocNumber) ||
                (nextStep === 6 && !capexRequired && capexRequired !== false) ||
                (nextStep === 6 && capexRequired && !capexDetails)
              }
            >
  ...
  return (
    <Layout title="Workflow Management - Steps 1-7">
      <div className="space-y-8">
          ...
          <Card className="bg-gradient-to-br from-orange-50 to-orange-100 border-orange-200">
            <CardContent className="p-6">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="text-orange-600 text-sm font-medium">MOC Required</p>
                  <p className="text-2xl font-bold text-orange-900">
                    {initiatives.filter(i => i.currentStep >= 4 && i.currentStep <= 5).length}
                  </p>
                </div>
              </div>
            </CardContent>
          ...
          <Card className="bg-gradient-to-br from-purple-50 to-purple-100 border-purple-200">
            <CardContent className="p-6">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="text-purple-600 text-sm font-medium">CAPEX Review</p>
                  <p className="text-2xl font-bold text-purple-900">
                    {initiatives.filter(i => i.currentStep >= 6 && i.currentStep <= 7).length}
                  </p>
                </div>
              </div>
            </CardContent>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-xl font-bold text-slate-800">OpEx Initiative Workflow Process (Steps 1-7)</CardTitle>
          </CardHeader>
          <CardContent>
                ...
                <React.Fragment key={stage.step}>
                  <div className="flex flex-col items-center text-center min-w-0 flex-1">
                    <div className={`w-10 h-10 rounded-full flex items-center justify-center text-white font-bold text-sm ${
                      index < 3 ? 'bg-blue-500' : index < 5 ? 'bg-orange-500' : 'bg-green-500'
                    }`}>
                      {stage.step}
                    </div>
