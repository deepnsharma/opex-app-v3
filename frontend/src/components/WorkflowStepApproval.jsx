...
const WorkflowStepApproval = ({ 
  ...
  const WORKFLOW_STAGES = [
    ...
    { step: 4, name: "MOC required?", role: "IL", responsibility: "Initiative Lead", description: "Determine if Management of Change is required" },
    { step: 5, name: "MOC", role: "IL", responsibility: "Initiative Lead", description: "Complete Management of Change process" },
    { step: 6, name: "CAPEX required?", role: "IL", responsibility: "Initiative Lead", description: "Determine if Capital Expenditure approval is required" },
    { step: 7, name: "CAPEX Process", role: "STLD", responsibility: "Site TSD Lead", description: "Complete Capital Expenditure approval process" }
  ];
  ...
  const handleApprove = () => {
    ...
    const stepData = {
      ...
      ...(currentStep === 6 && { capexRequired, capexDetails: capexRequired ? capexDetails : null })
    };
          ...
          <div className="space-y-4">
            <div className="bg-orange-50 p-4 rounded-lg">
              ...
              <p className="text-sm text-orange-600">
                Determine if this initiative requires a formal Management of Change process.
              </p>
            </div>
            <div>
        ...
        return (
          <div className="space-y-4">
            <div className="bg-orange-50 p-4 rounded-lg">
              <h4 className="font-medium text-orange-800 mb-2 flex items-center">
                <FileText className="mr-2 h-4 w-4" />
                MOC Process Completion
              </h4>
              <p className="text-sm text-orange-600">
                Confirm that the Management of Change process has been completed successfully.
              </p>
            </div>
            <div className="bg-white p-4 border border-gray-200 rounded-lg">
              <p className="text-sm text-gray-600">
                <strong>MOC Status:</strong> The MOC process for this initiative should be completed before approval.
                Verify that all safety, operational, and regulatory requirements have been addressed.
              </p>
            </div>
          </div>
        );
          ...
          <div className="space-y-4">
            <div className="bg-green-50 p-4 rounded-lg">
              ...
              <p className="text-sm text-green-600">
                Determine if this initiative requires capital expenditure approval.
              </p>
            </div>
            <div>
        ...
        return (
          <div className="space-y-4">
            <div className="bg-green-50 p-4 rounded-lg">
              <h4 className="font-medium text-green-800 mb-2 flex items-center">
                <DollarSign className="mr-2 h-4 w-4" />
                CAPEX Process Completion
              </h4>
              <p className="text-sm text-green-600">
                Confirm that the CAPEX approval process has been completed and funds are allocated.
              </p>
            </div>
            <div className="bg-white p-4 border border-gray-200 rounded-lg">
              <p className="text-sm text-gray-600">
                <strong>CAPEX Status:</strong> The capital expenditure approval should be completed before proceeding.
                Verify budget allocation and procurement approvals are in place.
              </p>
            </div>
          </div>
        );
